...
import com.company.oopLocals.Local;
...
public class Zodiac {
        ...
        private static String[] signs = {"Aries", "Taurus", "Gemini", "Cancer","Leo","Virgo","Libra",
                "Scorpio","Sagittarius","Capricorn","Capricorn","Aquarius","Pisces"};
    ...
    public static void main(String[] args) throws ParseException {
        ZodiacSings[] zodiacSings = new ZodiacSings[count];
        for (int i = 0; i < count; i++)
            zodiacSings[i] = new ZodiacSings(signs[i], dates[i][0], dates[i][1]);
        ...
        for (int i = 0; i<count; i++){
            ...
            calendarBegin.setTime(zodiacSings[i].getDateBegin());
            calendarBegin.set(Calendar.YEAR, calendar.get(Calendar.YEAR));
            calendarEnd.setTime(zodiacSings[i].getDateEnd());
        ...
        ResourceBundle bundleRU = ResourceBundle.getBundle("com\\company\\data\\Sings", localeRU);
        String signRU = bundleRU.getString(signs[sign]);
        ResourceBundle bundleUS = ResourceBundle.getBundle("com/company/data/Sings", localeEN);
        String signEN = bundleUS.getString(signs[sign]);
        System.out.println("Вы "+signRU);
        System.out.println("You are "+signEN);
    }
    }
    class ZodiacSings  {
    private String name;
    ...
    private Date dateEnd;
        ...
        public ZodiacSings(String name, String sDateBegin, String sDateEnd) throws ParseException {
            this.name = name;
